...
function ServiceProviderRegistrationForm() {
  ...
  useEffect(() => {
    ...
    axios
      .get('http://100.25.222.45:5000/api/v1/categories')
      .then(response => {
    ...
    axios
      .get('http://100.25.222.45:5000/api/v1/locations')
      .then(response => {
  ...
  if (selectedLocation) {
    ...
    axios
      .post('http://100.25.222.45:5000/api/v1/locations', newLocation)
      .then(response => {
	    ...
	    description,
          ...
          axios
            .post('http://100.25.222.45:5000/api/v1/service_providers', newServiceProvider)
            .then(response => {
